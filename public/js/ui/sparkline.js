/* =========================================================================
   ...
   *מתי* הרוח מגיעה, כמה זמן היא נשארת, והאם היא בשיא או בגסיסה.
   ...
   3. סקאלת ה-Y קבועה 0→35 קשר כדי ששני כרטיסים יהיו ברי-השוואה בעין.
...
function geometry(opts = {}) {
  ...
  /** 0 קשר על הבסיס, 35 קשר בתקרה. הצמדה (clamp) ולא חיתוך. */
  const Y = (kt) => {
    const v = num(kt);
...
/** סימון הצמדה לתקרה — מעל 35 קשר הערך נצמד, והגולש חייב לדעת שנחתך */
