/* =========================================================================
   ...
   `npm test` שומר על זה: הוא מגבב את קבצי השלד ומשווה ל-SHELL_HASH
   שמתחתיו, ונופל עם הערך החדש ברגע שהתוכן זז.
   ========================================================================= */

const CACHE_V = 'kite-v9';

// גיבוב (sha256, שמונה תווים) של תוכן SHELL_FILES. אינו נקרא בזמן ריצה —
// הוא עוגן לבדיקה, שמחשבת אותו מחדש ונופלת אם הוא לא תואם.
// לעדכן אותו יחד עם CACHE_V, לעולם לא לבד: הערך מתעד מה נפרס,
// וההגדלה היא מה שמפנה בפועל את המטמון הישן.
const SHELL_HASH = '4005be34';
